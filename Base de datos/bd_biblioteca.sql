...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-01-2022 a las 19:53:56
...
(1, '1', 4, 'Harry potter', 'prueba', 'prueba', 'USA', 200, '2000', 1, 26),
(2, '2', 4, 'Harry potter 2', 'prueba', 'prueba', 'prueba', 200, '2001', 1, 16);
...
(1, '17340346', 'jaime', '1234', 'geekappleman@gmail.com', 1, 1),
(2, '123', 'noan', '123', 'noan@gmail.com', 1, 1),
(10, '19', 'prueba', '123', 'prueba@gmail.com', 1, 2),
(11, '1233', 'jaime2', '123', 'prueba2@gmail.com', 1, 2);
...
--
ALTER TABLE `tb_prestamo`
  MODIFY `id_prestamo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
