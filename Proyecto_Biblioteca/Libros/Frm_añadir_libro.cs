...
{
    public partial class Frm_añadir_libro : Form
    {
        public Frm_añadir_libro()
        {
            InitializeComponent();
        }
        ...
        private void btn_registrar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (combo_estatus.Text == "Inactivo")
                {
                    estatus = "2";
                }
                try
                {
                    ...
                    obj_libros.registrar(txt_codigo_libro.Text, txt_nombre.Text, txt_cantidad_libros.Text, txt_autor.Text, txt_genero.Text, txt_pais_autor.Text, txt_numero_pag.Text, txt_año_edicion.Text, estatus,this);
                }
                catch (Exception)
                {
